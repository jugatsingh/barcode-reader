#############################################################################
# Makefile for building: PBL
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  PBL.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile PBL.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /usr/local/lib/libopencv_calib3d.so /usr/local/lib/libopencv_core.so /usr/local/lib/libopencv_features2d.so /usr/local/lib/libopencv_flann.so /usr/local/lib/libopencv_highgui.so /usr/local/lib/libopencv_imgcodecs.so /usr/local/lib/libopencv_imgproc.so /usr/local/lib/libopencv_ml.so /usr/local/lib/libopencv_objdetect.so /usr/local/lib/libopencv_photo.so /usr/local/lib/libopencv_shape.so /usr/local/lib/libopencv_stitching.so /usr/local/lib/libopencv_superres.so /usr/local/lib/libopencv_ts.a /usr/local/lib/libopencv_video.so /usr/local/lib/libopencv_videoio.so /usr/local/lib/libopencv_videostab.so -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = imagebar.cpp moc_ui_design.cpp
OBJECTS       = imagebar.o \
		moc_ui_design.o
...
Makefile: PBL.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/PBL1.0.0 || mkdir -p .tmp/PBL1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PBL1.0.0/ && $(COPY_FILE) --parents ui_design.h .tmp/PBL1.0.0/ && $(COPY_FILE) --parents imagebar.cpp .tmp/PBL1.0.0/ && (cd `dirname .tmp/PBL1.0.0` && $(TAR) PBL1.0.0.tar PBL1.0.0 && $(COMPRESS) PBL1.0.0.tar) && $(MOVE) `dirname .tmp/PBL1.0.0`/PBL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PBL1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_ui_design.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ui_design.cpp
moc_ui_design.cpp: /usr/include/qt5/QtCore/QVariant \
...
imagebar.o: imagebar.cpp /usr/local/include/opencv2/highgui/highgui.hpp \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imagebar.o imagebar.cpp

moc_ui_design.o: moc_ui_design.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ui_design.o moc_ui_design.cpp
